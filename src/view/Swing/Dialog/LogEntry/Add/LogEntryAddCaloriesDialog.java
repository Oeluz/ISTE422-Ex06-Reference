...
public class LogEntryAddCaloriesDialog extends JDialog {
    private Logs logs;
     ...
     * Create the dialog.
     */
    public LogEntryAddCaloriesDialog(Logs logs) {
        this.logs = logs;
        this.logListener = new LogChangeListener(logs);

        setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
        setResizable(false);
        setTitle("Add Log Calories");
        ...
        CreateComponent.createJLabel("Calories", 0, 1, contentPanel);
        textFieldCalories = CreateComponent.createJTextField("0", 1, 1, contentPanel);
            ...
            saveButton.addActionListener(e -> {
                try {
                    ...
                    if (result == JOptionPane.YES_OPTION) {
                        ...
                        LogEntry log = new LogEntry(LocalDate.parse(textFieldDate.getText()), LogEntry.LOG_TYPE.WEIGHT, Double.parseDouble(textFieldCalories.getText()));
