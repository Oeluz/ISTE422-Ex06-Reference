...
public class LogEntryEditWeightDialog extends JDialog {
     ...
     * Create the dialog.
     */
    public LogEntryEditWeightDialog(Logs logs, LogChangeListener logListener, int index) {
        this.logs = logs;
        this.logListener = logListener;
        this.index = index;
        setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
        setResizable(false);
        setTitle("Edit Log Weight");
        ...
        textFieldWeight = CreateComponent.createJTextField(String.valueOf(logs.logEntries.get(index).getValue()), 1, 1, contentPanel);
            ...
            saveButton.addActionListener(e -> {
                try {
                    ...
                    if (result == JOptionPane.YES_OPTION) {
                        ...
                        log.setValue(Double.parseDouble(textFieldWeight.getText()));
