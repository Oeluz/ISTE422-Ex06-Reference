...
public class LogEntryEditExerciseDialog extends JDialog {

    private final JPanel contentPanel = new JPanel();
    private Logs logs;
    private JTextField textFieldDate;
    private JTextField textFieldMinutes;
    private Collection<Exercise> keySet;
     ...
     * Create the dialog.
     */
    public LogEntryEditExerciseDialog(Logs logs, LogChangeListener logListener, int index) {
        this.logs = logs;
        this.logListener = logListener;
        this.index = index;
        keySet = logs.exercises.values();
        arrayList = new ArrayList<Exercise>(keySet);
        setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
        setResizable(false);
        setTitle("Edit Log Exercise");
        ...
        textFieldMinutes = CreateComponent.createJTextField(String.valueOf(logs.logEntries.get(index).getExercise().getMinutes()), 1, 1, contentPanel);
        ...
        panel.add(scrollPane, BorderLayout.CENTER);
        {
            ...
            for(Exercise exercise : arrayList){
                if (exercise.getName().equals(logs.logEntries.get(index).getExercise().getName())){
                ...
                okButton.addActionListener(e -> {
                    try {
                        ...
                        if (result == JOptionPane.YES_OPTION) {
                            ...
                            Exercise exercise = arrayList.get(list.getSelectedIndex());
